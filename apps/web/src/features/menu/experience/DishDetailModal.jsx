...
export function DishDetailModal({
  ...
  function handleContentScroll() {
    ...
    // Show compact bar once most of the photo has scrolled away
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[70] flex items-end justify-center bg-[var(--g-ink)]/15 p-0 backdrop-blur-[2px] sm:items-center sm:p-4">
        ...
        <motion.div
          ...
          className="relative z-10 flex w-full min-w-0 max-w-lg flex-col overflow-hidden rounded-t-3xl border border-stone-200/90 bg-[#FAF8F5] shadow-2xl sm:rounded-2xl"
          style={{
        ...
        >
          ...
          {/* Compact sticky title — appears after the photo scrolls up */}
          <AnimatePresence>
            {compactHeader ? (
              <motion.div
